...
--
-- Host: localhost
-- Generation Time: May 17, 2024 at 03:54 PM
...
CREATE TABLE `packages` (
  ...
  `flight_status` int(2) NOT NULL DEFAULT 0,
  `package_nights` int(8) NOT NULL DEFAULT 5
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
--
ALTER TABLE `packages`
  MODIFY `package_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
