...
if (isset($_POST['insert_post'])) {
    ...
    $insert_package = "insert into packages (package_cat, package_type, package_title, package_price, package_desc, package_image, package_keywords,flight_status,package_Hotel,package_activity,Flight_Details) values ('$package_cat','$package_type','$package_title','$package_price','$package_desc','$package_image','$package_keywords','$flight_status','$package_Hotel','$package_activity','$Flight_Details')";
    ...
    <form action="insert_package.php" method="post" enctype="multipart/form-data">
        <table align="center" width="795" border=2px bgcolor="ABB3C8">
            ...
            <tr>
                ...
                <td><input required type="text" name="package_title" size="60"></td>
            </tr>
            <tr>
                <td align="right"><b>Package Category:</b></td>
                <td>
                    <select required name="package_cat">
            ...
            <tr>
                ...
                <td>
                    <select required name="flight_status">
                        <option value=''>Select a type</option>
                        <option value='1'>With Flight</option>
            ...
            <tr>
                ...
                <td><input required type="file" name="package_image"></td>
            </tr>
            <tr>
                <td align="right"><b>Package Price:</b></td>
                <td><input required type="text" name="package_price"></td>
            </tr>
            <tr>
                <td align="right"><b>Hotel Name:</b></td>
                <td><input required type="text" name="package_Hotel" ></td>
            </tr>
            <tr>
                <td align="right"><b>Package Description:</b></td>
                <td><textarea required name="package_desc" cols="20" rows="10"></textarea></td>
            </tr>
            <tr>
                <td align="right"><b>Package Activity:</b></td>
                <td><textarea required name="package_activity" cols="20" rows="10"></textarea></td>
            </tr>
            <tr>
                <td align="right"><b>Package Flight:</b></td>
                <td><textarea required name="Flight_Details" cols="20" rows="10"></textarea></td>
            </tr>
            <tr>
                <td align="right"><b>Package Keywords:</b></td>
                <td><input required type="text" name="package_keywords" size="70"></textarea></td>
            </tr>
            <tr>
                <td align="right"><b>Package Nights:</b></td>
                <td><input required type="number" name="package_nights" size="70"></textarea></td>
            </tr>
            <tr align="center">
