...
function getFlights()
{
        echo "<li><a href='index.php?flight=0'>Without Flight</a></li><li><a href='index.php?flight=1'>With Flight</a></li>";
}
...
function getCatPack()
{
    if (isset($_GET['cat'])) {
        ...
        while ($row_cat_pack = mysqli_fetch_array($run_cat_pack)) {
            ...
            $pack_nights = $row_cat_pack['package_nights'];
...
function getTypePack()
{
    if (isset($_GET['type'])) {
        ...
        while ($row_type_pack = mysqli_fetch_array($run_type_pack)) {
            ...
            $pack_nights = $row_type_pack['package_nights'];
...
function getFlightPack()
{
    if (isset($_GET['flight'])) {
        $type_id = $_GET['flight'];
        global $con;
        $get_type_pack = "select * from packages where flight_status='$type_id'";
        ...
        while ($row_type_pack = mysqli_fetch_array($run_type_pack)) {
            ...
            echo "<a href='details.php?pack_id=$pack_id' style='float: left;'>
            <div id='single_package' style='background-image:url(admin_area/package_images/$pack_image)'>
            <div class='package_info'>
            <h5 class='title'>
            Nights/$pack_nights
